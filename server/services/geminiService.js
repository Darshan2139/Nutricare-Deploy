...
export class GeminiService {
    ...
    async generateDietPlan(request) {
        try {
    ...
    buildPrompt(healthData, userPreferences) {
        const { age, height, weight, bmi, trimester, hemoglobinLevel, bloodSugar, bloodPressure, medicalHistory, vitaminD, vitaminB12, vitaminA, vitaminC, calcium, ironLevels, dietPreference, foodAllergies, religiousCulturalRestrictions, activityLevel, sleepHours, waterIntake, isMultiple, multipleType, isHighRisk, currentSupplements, notes } = healthData;
